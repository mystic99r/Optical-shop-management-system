...
class CustomerReport extends JInternalFrame implements ActionListener
{
	...
	CustomerReport()
	{
		super("Customer Report",true,true,true,true);
		drawFrame();
		try
		{
	...
	void drawFrame()
	{
		...
		l1=new JLabel("Customer Report",JLabel.CENTER);
	...
	void setTable()
	{
		try
		{
			String query="select cid as Customer_id,cname as CustomerName,caddr as CustomerAddress,contact as ContactNo from Customer ";
